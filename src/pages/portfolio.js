...
const ProjectPage = () => {
  ...
  return (
    <Layout>
      <SEO title="Portfolio" keywords={['Sai Sumanth portfolio', 'Sai Sumanth projects', 'Sai7xp portfolio']} />
      <h3># Things built with Curiosity</h3>
      {featuredProjectsList.map((project, idx) => (
        <Project key={idx} project={project} />
      ))}

      <h2 style={{ marginTop: '2em' }}>Other Projects</h2>
