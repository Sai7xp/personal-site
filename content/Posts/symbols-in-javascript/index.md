...
modified_date: '2021-03-23T13:15:03.284Z'
categories:
  - Javascript
  - Web
slug: /symbols-in-javascript/
...
But if we have used a string `"id"` instead of a symbol for the same purpose, then there *would* be a conflict as we seen above.
